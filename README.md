...
- [ ] Полное E2E-тестирование на реальном устройстве (Алматы / РФ) — ждём
      ...
      v3.7.9 с исправленным native crash-логом) — впервые появится шанс
      увидеть РЕАЛЬНОЕ содержимое native-лога (маркеры входа в потоки,
      connection-чекпоинты, возможный `=== NATIVE CRASH ===` блок с
      сигналом). Тестовая сборка проверена на Linux x86_64

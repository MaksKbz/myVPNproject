...
- [ ] Полное E2E-тестирование на реальном устройстве (Алматы / РФ) — ждём
      ...
      v3.7.8 с нативными чекпоинтами соединений) — по числу последних
      "TCP client #N accepted"/"SOCKS5 client accepted" записей будет
      видно точное количество параллельных соединений в момент краха,
      что сузит поиск race condition в конкретном месте C-кода.

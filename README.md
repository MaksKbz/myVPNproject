...
- [ ] Полное E2E-тестирование на реальном устройстве (Алматы / РФ) — ждём
      от пользователя текста из карточки краша (после установки версии с
      CrashLogger) для точной диагностики оставшейся причины; тестовая
      сборка проверена на Linux x86_64
